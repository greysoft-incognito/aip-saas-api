...
class SendVerified extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        $message = [
            ...
            'message_line1' => __('You are receiving this email because you just verified your at account :0 and we want to use this medium to welcome you into our community', [
    ...
    {
        $message = __('Your :0 account has been verified successfully, welcome to our community.', [
            config('settings.site_name')
        ]);
